...
fun getResourceAsString(path: String, encoding:String|Null = null):String = java!org::mule::munit::tools::util::GetResourceFunctions::getResourceAsString(path, encoding)
